...
export class PickerScene extends Phaser.Scene {
  ...
  private buildCardGrid(): void {
    ...
    filtered.forEach((unit, i) => {
      ...
      } else if (unit.id === 'geek') {
        drawGeekIcon(icon, cx, iconTop + iconSize / 2, iconSize, unit.color)

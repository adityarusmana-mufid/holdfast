...
export const UNIT_CONFIGS: UnitConfig[] = [
  ...
  },
  {
    ...
    damageType: 'kinetic',
    attackInterval: 1.6,
    rangePattern: [[-2,-1],[-2,0],[-2,1],[-1,-1],[-1,0],[-1,1],[0,-1],[0,0],[0,1]],
    blockCount: 0,
    dpCost: 14,
    redeployTime: 15,
    color: 0xf1c40f,
  ...
  },
  {
    ...
    damageType: 'kinetic',
    attackInterval: 2.3,
    rangePattern: [[-2,-1],[-2,0],[-2,1],[-1,-1],[-1,0],[-1,1],[0,0]],
    blockCount: 0,
    dpCost: 18,
    redeployTime: 15,
    color: 0x9966ff,
    traits: [{ traitId: UnitTrait.SpreadAttack }],
    skills: SKILLS['spreadshooter'],
  },
  {
    id: 'besieger',
    name: 'Sniper',
    archetype: 'sniper',
    subtypeLabel: 'Besieger',
    type: 'ranged',
    hp: 1000,
    atk: 480,
    def: 80,
    ...
    damageType: 'kinetic',
    attackInterval: 2.4,
    rangePattern: [[-4,-1],[-4,0],[-4,1],[-3,-2],[-3,-1],[-3,0],[-3,1],[-3,2],[-2,-2],[-2,-1],[-2,0],[-2,1],[-2,2],[0,0]],
    blockCount: 0,
    dpCost: 16,
    redeployTime: 15,
    color: 0x5d4037,
    traits: [],
    skills: SKILLS['besieger'],
  },
  {
    id: 'flinger',
    name: 'Sniper',
    archetype: 'sniper',
    subtypeLabel: 'Flinger',
    type: 'ranged',
    hp: 1100,
    atk: 380,
    def: 90,
    ...
    damageType: 'kinetic',
    attackInterval: 2.1,
    rangePattern: [[-3,-1],[-3,0],[-3,1],[-2,-2],[-2,-1],[-2,0],[-2,1],[-2,2],[-1,-2],[-1,-1],[-1,0],[-1,1],[-1,2],[0,-2],[0,-1],[0,0],[0,1],[0,2]],
    blockCount: 0,
    dpCost: 16,
    redeployTime: 15,
    color: 0x00a86b,
  ...
  },
  {
    ...
    damageType: 'kinetic',
    attackInterval: 3.5,
    rangePattern: [[-2,0],[-1,-1],[-1,0],[-1,1],[0,-1],[0,0],[0,1],[1,-1],[1,0],[1,1]],
    blockCount: 0,
    dpCost: 14,
    redeployTime: 70,
    color: 0x4a148c,
    traits: [{ traitId: UnitTrait.SpreadAttack }],
    skills: SKILLS['ambusher'],
  },
  // geek — commented out: HP drain trait (1%/s) not implemented
  // {
  //   id: 'geek',
  //   name: 'Geek',
  //   archetype: 'specialist',
